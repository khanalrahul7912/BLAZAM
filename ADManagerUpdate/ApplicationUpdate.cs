...
namespace ADManager.Update
{
    ...
    public class ApplicationUpdate : IEquatable<ApplicationUpdate?>
    {
       ...
       /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// eg: C:\user\appdata\local\temp\ADManager\update\
        ///</returns>
        ...
        /// </summary>
        /// <returns>
        /// eg: C:\inetpub\admanager\Writable\Update\Download\
        /// </returns>
        ...
        private async Task<bool> InitiateFileCopy(JobStep? step)
        {
            ...
            var proc = Process.Start("schtasks /run /tn \"Update AD Manager\"");

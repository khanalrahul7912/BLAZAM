...
using ADManager.Update.Exceptions;
...
namespace ADManager.Update.Services
{
    ...
    public class UpdateService : UpdateServiceBase
    {
        ...
        private const string Publisher_Name = "ADManager-APP";
        private const string Repository_Name = "AD Manager";
                    ...
                    case UpdateCredential.Custom:
                        ...
                        if (identity != null)
                        {
                            ...
                            return identity.Run(() =>
                            {
                                ...
                                var tempPath = Path.Combine(userProfile, "AppData", "Local", "Temp", "AD Manager", "update" + Path.DirectorySeparatorChar);

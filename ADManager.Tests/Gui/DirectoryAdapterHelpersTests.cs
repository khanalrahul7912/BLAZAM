using ADManager.ActiveDirectory.Interfaces; // Assuming this is the namespace for DirectoryAdapterHelpers
...
// For example:
// using ADManager.ActiveDirectory; // Or wherever IDirectoryEntryAdapter is defined
// using MudBlazor; // For Icons

namespace ADManager.Tests.Gui
{

...
using ADManager.Database.Models.Permissions;
...
namespace ADManager.Session.Interfaces
{
    ...
    public interface IApplicationUserState
    {
        ...
        /// <summary>
        /// Gets the application-specific preferences (e.g., theme, dark mode) for the user. See <see cref="ADManager.Database.Models.User.AppUser"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets the list of <see cref="ADManager.Database.Models.Permissions.PermissionDelegate"/> objects assigned to this user.
        /// </summary>
        List<PermissionDelegate> PermissionDelegates { get; set; }

        /// <summary>
        /// Gets or sets the list of effective <see cref="ADManager.Database.Models.Permissions.PermissionMapping"/> objects for this user, derived from their delegates and OU structure.
        /// </summary>
        List<PermissionMapping> PermissionMappings { get; set; }

        /// <summary>
        /// Gets or sets the list of <see cref="ADManager.Database.Models.Notifications.NotificationSubscription"/> for the user.
        /// </summary>

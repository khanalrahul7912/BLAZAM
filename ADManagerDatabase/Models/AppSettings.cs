...
namespace ADManager.Database.Models
{
    ...
    public class AppSettings : AppDbSetBase
    {
        ...
        /// </summary>
        public string? MOTD { get; set; } = "Welcome to AD Manager. Head over to the <a href=\"/settings\">settings</a> page to configure this application.<br/>To remove this message, modify or clear the Homepage Message settings on the <a href=\"/settings\">settings</a> page.";

...
{
    /// <summary>
    /// Provides extension methods to simplify encryption and decryption operations using the application's central <see cref="ADManager.Common.Data.Encryption"/> service.
    /// </summary>
    public static class EncryptionHelpers
    {
        ...
        /// </summary>
        /// <remarks>
        /// Relies on <see cref="ADManager.Common.Data.Encryption.Instance"/>. If decryption fails (e.g., due to invalid format, incorrect key, or if the input is null), this method returns default(T).
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Relies on <see cref="ADManager.Common.Data.Encryption.Instance"/>. If decryption fails or the input is null, this method returns an empty string.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Relies on <see cref="ADManager.Common.Data.Encryption.Instance"/>.
        /// </remarks>

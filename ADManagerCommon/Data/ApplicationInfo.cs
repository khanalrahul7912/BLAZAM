...

{
    ...
    public class ApplicationInfo
    {
        ...
        /// <summary>
        /// The running AD Manager version
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether AD Manager is running under IIS or as a service
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether AD Manager is in Debug Mode
        /// </summary>
        public bool InDebugMode { get => inDebugMode; set => inDebugMode = value; }

        /// <summary>
        /// Indicates whether AD Manager is in Demo Mode
        /// </summary>
        /// <remarks>
        ...
        public ApplicationInfo(WebApplicationBuilder builder)
        {
            ...
            TempDirectory = new SystemDirectory(Path.GetTempPath() + "AD Manager" + Path.DirectorySeparatorChar);

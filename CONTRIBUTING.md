...
We encourage contribution of all kinds. Everything from feature suggestions
to providing translations, all the way to bug fixes and code contributions.

## Translations
Translations are provided via the .resx files in ADManagerLocalization

### How to contribute
Translation suggestions can be done entirely in browser. Follow the steps below to contribute...
1. Create an account or Sign In to GitHub
2. Fork AD Manager
3. In your fork, navigate to ADManagerLocalization

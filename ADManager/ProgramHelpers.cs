...
#pragma warning restore S4830 // Server certificates should be verified during SSL/TLS connections
            ...
            builder.Services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo // Define API document information
                {
                    ...
                    Version = "v1",
                    Description = "The official AD Manager API documentation." +
                                  "<br/>Authorization is required for API access." +
                                  "<br/>The \"Authorization\" header value must be \"Bearer {token}\"",
                    License = new OpenApiLicense() { Name = "MIT License", Url = new Uri("https://github.com/khanalrahul7912/ADManager/blob/main/LICENSE") },
                    Contact = new()
                    {
                        Name = "AD Manager Support",
                        Url = new("https://github.com/khanalrahul7912/ADManager/issues")
                    },
                    TermsOfService = new Uri("https://github.com/khanalrahul7912/ADManager")
                });
                ...
                {
                    Description = "Enter only the token supplied by AD Manager (without 'Bearer ' prefix)", // User instruction
        ...
        /// from all loaded ADManager assemblies.
        /// </summary>
        public static WebApplicationBuilder InjectBackgroundServices(this WebApplicationBuilder builder)
        {
            ...
            Parallel.ForEach(admanagerAssemblies, assembly => // Use helper property to get ADManager assemblies
            {
                try
                {
        ...
        /// <summary>
        /// Helper property to get all loaded assemblies whose names contain "ADManager".
        /// Used to target specific assemblies for reflection tasks like service discovery.
        /// </summary>
        private static IEnumerable<Assembly> admanagerAssemblies => AppDomain.CurrentDomain.GetAssemblies()
                                                                    .Where(a => a.FullName?.Contains("ADManager", StringComparison.OrdinalIgnoreCase) == true);
        ...
        {
            foreach (var assembly in admanagerAssemblies)
            {
                try
                {
                    var types = assembly.GetTypes()

...
{
    /// <summary>
    /// Main entry point class for the ADManager web application.
    ...
    public static class Program
    {
        ...
        /// </summary>
        /// <returns>
        /// A SystemDirectory object representing the path, e.g., C:\inetpub\admanager\writable\
        /// </returns>
        ...
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerEndpoint("v1/swagger.json", "AD Manager API V1"); // Configure the endpoint
            });

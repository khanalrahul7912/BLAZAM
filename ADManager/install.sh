...
readonly ADManager_ZIP_FILENAME="admanager-dev-beta-v1.4.0.2025.06.26.2119.zip"
readonly DOWNLOAD_URL="https://github.com/khanalrahul7912/BLAZAM/releases/download/${ADManager_RELEASE_TAG}/${ADManager_ZIP_FILENAME}"

#Name ADManager Update Task Registration Script
#Purpose Registers a Windows Scheduled Task to run the ADManager updater at 2AM daily
#Version 1.0.0

$taskName    = "ADManager Auto Updater"
$taskDesc    = "Runs the ADManager update.ps1 script daily at 2:00 AM."
...
Write-Host ""
Write-Host "========================================="
Write-Host "  ADManager Scheduled Update Task Setup"
Write-Host "========================================="
Write-Host ""

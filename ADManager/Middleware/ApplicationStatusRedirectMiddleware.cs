...
using ADManager.Pages.Error;

namespace ADManager.Middleware
{
    /// <summary>
       ...
       ConnMonitor monitor)
    {
        ...
        private readonly List<string> _uriIgnoreList = ["/static", "/css", "/_content", "/_blazor", "/ADManager.styles.css", "/_framework"];

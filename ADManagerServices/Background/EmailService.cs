...
using ADManager.EmailMessage;
using ADManager.EmailMessage.Email;
using ADManager.EmailMessage.Email.Base;
using ADManager.EmailMessage.Email.Messages;
    ...
    public class EmailService : DatabaseBackgroundServiceBase
    {
        ...
        public async Task<bool> SendTestEmail(string to)
        {
            try
            {
                ...
                var message = BuildMessage<TestEmailMessage>("ADManager Test Email", to);

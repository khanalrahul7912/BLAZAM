using ADManager.Common.Exceptions;
using ADManager.Common.Helpers;
using System.Net;
...
namespace ADManagerCommon.Tests.Helpers
{
    public class NetworkToolsTests
    {
        ...
        public void PingHost_NonExistentHost_ReturnsFalse()
        {
            ...
            Assert.False(NetworkTools.PingHost("nonexistent-domain-for-admanager-tests.example.com"));

            Assert.False(NetworkTools.PingHost("another-unlikely-hostname-admanager.admanager"));

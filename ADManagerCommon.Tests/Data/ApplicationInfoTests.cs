using ADManager.Common.Data; // Assuming ApplicationInfo, SystemDirectory, ApplicationVersion are here
using ADManager.FileSystem;
using ADManager.Plugins;    // Assuming IPluginBase is here
using Microsoft.Extensions.Configuration;
using Moq;
using System.Diagnostics;

namespace ADManagerCommon.Tests.Data
{
